package com.fh.controller.candidategenes.candidategene;
...
import com.fh.service.candidategenes.candidategene.CandidateGeneService;
...
public class CandidateGeneController extends BaseController {
	...
	public ModelAndView list(Page page){
		...
		try{
			...
			mv.setViewName("candidategenes/candidategene/candidategene_list");
	...
	public ModelAndView goAdd(){
		...
		pd = this.getPageData();
		try {
			mv.setViewName("candidategenes/candidategene/candidategene_edit");
