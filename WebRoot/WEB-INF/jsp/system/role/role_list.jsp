        ...
        <div class="row-fluid">
            ...
            <table id="table_report" class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    ...
                    <th class="center" style="width:160px;">角色名称</th>
                        ...
                        <c:forEach items="${roleList_z}" var="var" varStatus="vs">
                            ...
                            <tr>
                                ...
                                <td class="center">
                                    ...
                                    <a class="tooltip-error" data-rel="tooltip"  onclick="editRights('${var.ROLE_ID }');">菜单权限</a>&nbsp;
                                    <a class="tooltip-error" data-rel="tooltip"  title="编辑"
                                       onclick="editRole('${var.ROLE_ID }');">编辑</a>&nbsp;
                                    <a class="tooltip-error" data-rel="tooltip"  title="删除"
                                       onclick="delRole('${var.ROLE_ID }','${var.ROLE_NAME }');">删除</a>
