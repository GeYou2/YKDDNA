package com.fh.controller.reportmanagement;
...
import com.fh.service.reportmanagement.pictures.PicturesService;
...
public class ReportController extends BaseController {
	...
	public ModelAndView list(Page page){
		...
		try{
			...
			mv.setViewName("reportmanagement/pictures/pictures_list");
	...
	public ModelAndView goAdd(){
		...
		pd = this.getPageData();
		try {
			mv.setViewName("reportmanagement/pictures/pictures_add");
			mv.addObject("pd", pd);
		} catch (Exception e) {
			logger.error(e.toString(), e);
		}						
	...
	public ModelAndView goEdit(){
		...
		try {
			...
			mv.setViewName("reportmanagement/pictures/pictures_edit");
